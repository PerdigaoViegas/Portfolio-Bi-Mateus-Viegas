# Portfólio de Business Intelligence – Mateus Viegas

Bem-vindo ao portfólio de projetos de **Business Intelligence (BI)** desenvolvido por **Mateus Viegas**.  
Este repositório reúne dashboards construídos em **Microsoft Power BI**, com foco em análise de dados, criação de indicadores e apoio à tomada de decisão.

---

## 👨‍💻 Sobre o profissional

Sou o **Mateus Viegas**, profissional em desenvolvimento na área de **Análise de Dados e BI**, com experiência em:

- Modelagem de dados para relatórios gerenciais  
- Criação de **dashboards interativos em Power BI**  
- Construção de indicadores (KPIs) para áreas Comercial, Compras, Financeiro e Recursos Humanos  
- Análise de desempenho e apoio a decisões estratégicas
